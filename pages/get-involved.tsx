                ...
                >
                    ...
                    <div className = "bg-white w-full my-2 flex flex-col items-start p-2 rounded-xl">
                        <div className='flex flex-wrap flex-row w-full justify-start items-center'>
                            <div className = "text-black font-bebas text-5xl my-2 ml-2 tracking-wide">
                        ...
                        <div className="flex flex-wrap justify-center md:flex-row w-full items-center gap-x-32 gap-y-10">
                            ...
                            <div className="leading-relaxed md:w-2/5 text-lg text-center text-gray-700 p-4 rounded-lg">
