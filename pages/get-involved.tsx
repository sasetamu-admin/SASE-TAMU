    ...
    return (
        <>
            ...
            <div className='bg-navy font-source text-paper overflow-x-hidden overflow-y-hidden'>
                <div className=' flex h-screen items-center justify-center bg-white bg-squad bg-cover bg-fixed bg-center' style={{ opacity, transition: "opacity 0.3s linear" }}>
                ...
                >
                    ...
                    <div className = "bg-navy w-full my-2 flex flex-col items-start p-2 rounded-xl">
                        <div className='flex flex-wrap flex-row w-full justify-start items-center'>
                            ...
                            <motion.div className = "text-maroon font-bebas text-5xl font-bold my-2 ml-2 tracking-wide hover:text-6xl hover:text-maroonDark transition-all duration-500 ease-in-out"
                        ...
                        <div className="flex flex-wrap justify-center md:flex-row w-full items-center gap-x-32 gap-y-10">
                    ...
                    <div className = "bg-navy w-full my-2 flex flex-col items-start p-2 rounded-xl">
                        ...
                        <div className="flex flex-wrap justify-center md:flex-row-reverse w-full items-center gap-x-32 gap-y-10">
